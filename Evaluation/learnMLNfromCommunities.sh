...
$5/createrules/createrules $6/$1.rules 0 $6/$2 $6/$1.comb.ldb $6/$1.uldb $6/$3 $5/alchemy30/bin/learnwts $5/createrules/tmpdir 0.5 0.1 0.1 100 5 100 1000 1 $7/$1-rules.mln 1 - - true false 40 > $7/$1-createrules.log
