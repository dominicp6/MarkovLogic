...
class Path
{
 private:
  ...
  StringHashArray* supportIdStrs2_;


 public:
  Path(Atom** const& atoms, const int& numAtoms) : atoms_(atoms), numAtoms_(numAtoms), support_(0), supportIdStrs_(NULL), supportIdStrs2_(NULL)
  ...
  ~Path() { delete [] atoms_;  delete supportIdStrs_; delete supportIdStrs2_; }
  ...
  StringHashArray* supportIdStrs2() const { return supportIdStrs2_; }
  ...
  void   addSupportIdStr2(const string& idStr) { if (supportIdStrs2_==NULL) supportIdStrs2_ = new StringHashArray; supportIdStrs2_->append(idStr); }
  void   addSupportIdStr2(const Array<string>& idStrArr) 
  { 
    if (supportIdStrs2_==NULL) supportIdStrs2_ = new StringHashArray; 
    for (int i = 0; i < idStrArr.size(); i++)
      supportIdStrs2_->append( idStrArr[i] ); 
  }
